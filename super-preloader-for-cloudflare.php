...
require_once WPFF_SP_PLUGIN_PATH . 'includes/class-wpff-sp-helpers.php';
require_once WPFF_SP_PLUGIN_PATH . 'includes/class-wpff-sp-http-request.php';
...
require_once WPFF_SP_PLUGIN_PATH . 'includes/class-wpff-sp-cloudflare-analytics.php';
...
add_filter(
	...
	array( 'WPFF_SP_Helpers', 'add_settings_link' )
);
...
add_action( 'wp_ajax_wpff_sp_run_preloader', array( 'WPFF_SP_Ajax', 'run_preloader' ) );
...
add_action( 'wp_ajax_wpff_sp_get_urls_table', array( 'WPFF_SP_Ajax', 'get_urls_table' ) );
...
// AJAX hook for the Cache Coverage cards (sidebar + Stats tab)
add_action( 'wp_ajax_wpff_sp_get_cache_coverage', array( 'WPFF_SP_Ajax', 'get_cache_coverage' ) );
...
add_action( 'wpff_sp_run_preloader', array( 'WPFF_SP_Preloader', 'run' ), 10, 1 );

// ============================================================
// Activation / Deactivation
// ============================================================

register_activation_hook( __FILE__, array( 'WPFF_SP_Cron', 'on_activation' ) );
register_deactivation_hook( __FILE__, array( 'WPFF_SP_Cron', 'on_deactivation' ) );
