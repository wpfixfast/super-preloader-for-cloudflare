...
<div class="wpff-sp-setup-guide postbox mt-40">
  <div class="inside">
    <h2><?php echo esc_html(__('Getting Started', 'super-preloader-for-cloudflare')); ?></h2>
    <p>
      <?php echo esc_html__(
...
?>
  ...
  'super-preloader-for-cloudflare'
    ...
    <h2><?php echo esc_html(__('How to Use', 'super-preloader-for-cloudflare')); ?></h2>
    <ul class="ul-disc">
      <li>
      ...
      <li>
        <a href="https://wpfixfast.com/blog/preload-cloudflare-cache/#how-to-create-and-deploy-a-cloudflare-worker" target="_blank" rel="noopener">
          <?php echo esc_html(__('How to create and deploy a Cloudflare Worker', 'super-preloader-for-cloudflare')); ?>
        </a>
      </li>
      <li>
        <a href="https://wpfixfast.com/blog/preload-cloudflare-cache/#how-to-register-and-use-webshare-proxies" target="_blank" rel="noopener">
          <?php echo esc_html(__('How to register and use Webshare Proxies', 'super-preloader-for-cloudflare')); ?>
        </a>
      </li>
      <li>
